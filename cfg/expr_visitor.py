...
class ExprVisitor(StmtVisitor):
    ...
    def init_cfg(self, node):
        ...
        print("STATEMENTS: ", module_statements)
    ...
    def save_def_args_in_temp(
        ...
        for i, call_arg in enumerate(call_args):
            ...
            def_arg_temp_name = 'temp_' + \
                str(saved_function_call_index) + '_' + def_args[i]
    ...
    def visit_and_get_function_nodes(
        ...
        exit_node = self.append_node(
            EntryOrExitNode('Exit ' + definition.name))
